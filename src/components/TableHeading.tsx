...
import { faArrowsAltV, faArrowUp, faArrowDown, faFilter, faFill, faSearch } from '@fortawesome/free-solid-svg-icons';
		...
		<th scope="col" key={cell.key} >
					<div className={styles.container}>
						...
						<div className={styles.actions}>
							...
							<button className="btn btn-primary m-1" onClick={() => props.onShowFilter(key)}><FontAwesomeIcon icon={faFilter} /></button>
							<button className="btn btn-primary m-1" onClick={() => props.onSort(key)}><FontAwesomeIcon icon={getSortStateIcon()} /></button>
						</div>
					</div>
				</th>
	);
